...
# Just use starship for now
# but maybe, play around with their functionality to make something natively?
let-env PROMPT_COMMAND = "starship prompt"

alias dfgit = git --git-dir $"($env.HOME)/.dotfile_config/" --work-tree $"($env.HOME)"
